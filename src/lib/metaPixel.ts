...
export const FB_PIXEL_ID_4 = '1807595270425119'; // pixel GD tunnel

export const FB_PIXEL_ID = FB_PIXEL_ID_1;
export const FB_PIXEL_IDS = [FB_PIXEL_ID_1, FB_PIXEL_ID_2, FB_PIXEL_ID_3, FB_PIXEL_ID_4].filter(Boolean);
