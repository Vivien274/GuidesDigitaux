...
export const DEFAULT_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    "description": "S’assurer que tous les éléments essentiels de tes profils sociaux sont correctement configurés pour être visible, crédible et convertir tes abonnés en clients.",
    "longDescription": "<h3>Convertis tes abonnés réseaux sociaux en clients fidèles pour ton entreprise</h3>\n<p>Sur Instagram, Facebook ou LinkedIn, ton profil professionnel est ta première vitrine virtuelle. Lorsqu'un habitant de ta ville ou de la Métropole lilloise découvre tes publications d'artisan ou de créateur, son premier réflexe est de cliquer sur ton profil. S'il y trouve une biographie floue, des liens cassés ou des visuels amateurs, tu perds immédiatement un prospect qualifié. La <strong>Checklist Profil Réseaux Sociaux Pro</strong> te garantit une configuration irréprochable qui inspire confiance, renforce ta crédibilité et génère des contacts qualifiés.</p>\n\n<p>Conçue à partir des meilleures pratiques de neuromarketing et de conversion sur les réseaux sociaux pour indépendants, cette grille d'audit te permet d'optimiser tes comptes en moins de 20 minutes.</p>\n\n<h3>Les 4 étapes clés d'optimisation de tes profils professionnels</h3>\n<p>Passe en revue et coche chaque point stratégique de tes profils sociaux :</p>\n<ul>\n  <li><strong>Étape 1 : Informations générales & Biographie percutante</strong> : Rédiger une bio en 3 lignes percutantes (« Qui tu es », « Ce que tu apportes », « Pour qui ») avec des mots-clés métiers locaux et une photo de profil nette et professionnelle.</li>\n  <li><strong>Étape 2 : Contenu initial & Organisation des Stories à la une (Highlights)</strong> : Publier 3 à 5 posts fondateurs épinglés pour présenter ton savoir-faire et organiser tes stories à la une (Avis clients, Tarifs, Coulisses d'atelier, FAQ).</li>\n  <li><strong>Étape 3 : Cohérence visuelle & Boutons d'action stratégiques</strong> : Adopter une palette graphique représentative et configurer les boutons de contact direct (Appeler, Envoyer un e-mail, Lien vers le site web).</li>\n  <li><strong>Étape 4 : Interactions, messagerie & Modèles de réponses automatiques</strong> : Activer les messages privés professionnels sur <a href=\"https://instagram.com\" target=\"_blank\" rel=\"noopener noreferrer\">Instagram</a> et <a href=\"https://facebook.com\" target=\"_blank\" rel=\"noopener noreferrer\">Facebook</a> et préparer des modèles de réponses rapides pour traiter les demandes fréquentes.</li>\n</ul>\n\n<h3>Développe ta communauté locale et réoriente le trafic vers ton site web</h3>\n<p>Grâce à cette checklist méthodique :</p>\n<ul>\n  <li>Tu présenteras une image moderne et soignée de ton activité d'artisan.</li>\n  <li>Tu orienteras facilement tes abonnés sociaux vers ton site vitrine ou ta boutique en ligne.</li>\n  <li>Tu gagneras du temps au quotidien dans la gestion de ta communication digitale.</li>\n</ul>\n\n<p>Pour connecter tes réseaux sociaux à une stratégie digitale globale, découvre notre <a href=\"/produit/ebook-visibilite-ligne-artisan\">Ebook Visibilité en Ligne Artisan</a> et optimise l'ergonomie de ton site web avec la <a href=\"/produit/checklist-les-principes-ux\">Checklist des Principes Clés UX</a>. Retrouve l'ensemble de nos outils sur la <a href=\"/boutique\">boutique Guides Digitaux</a>.</p>\n\n<h3>Un format PDF dynamique prêt à l'emploi</h3>\n<p>Télécharge ta checklist immédiatement au format PDF dynamique ou imprimable et booste tes profils dès aujourd'hui ! Une question ? Écris à Stéphanie sur la <a href=\"/contact\">page de contact</a>.</p>",
    "features": [
  ...
  },
  {
    ...
    "downloadPdf": "/downloads/checklist-verification-lancement-site.pdf"
  },
  {
