        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 text-center sm:text-left">
          ...
          <div className="space-y-3">
            ...
            <p className="text-base sm:text-lg text-[#5e4d46] font-medium max-w-2xl">
              Mentions légales, éditeur, hébergement et politique de protection des données personnelles.
            </p>
          </div>
        </div>
      </section>
...
<p><br/>L’entreprise individuelle Stephanie ROCQ<br/>située : 40 rue du Hoccart, 59560 Comines<br/>immatriculée au RCS de Lille 82119498700038<br/>Numéro de déclaration d’activité (DA) : 32591460859<br/>n° de téléphone : 0782404062<br/>adresse mail : contact@guides-digitaux.com</p>
